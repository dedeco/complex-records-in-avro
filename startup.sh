...
kafka-topics --delete --zookeeper localhost:2181 --topic com.xpi.streams.users > startup/startup.log 2>&1
kafka-topics --delete --zookeeper localhost:2181 --topic com.xpi.streams.purchases > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.xpi.streams.users --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.xpi.streams.purchases --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
kafka-topics --delete --zookeeper localhost:2181 --topic com.xpi.streams.pages > startup/startup.log 2>&1
kafka-topics --delete --zookeeper localhost:2181 --topic com.xpi.streams.clickevents > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.xpi.streams.pages --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.xpi.streams.clickevents --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
